...
class AdminTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        link = Link(name='GitHub', url='https://github.com/hallucigenia')
    ...
    def test_edit_link(self):
        ...
        self.assertIn('https://github.com/hallucigenia', data)
